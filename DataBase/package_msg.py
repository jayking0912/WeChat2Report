            ...
            if strtalker.__contains__('@chatroom'):
                ...
                if row[4] == 1:
                    ...
                    if membersMap is not None:
                        ...
                        if sender =='' and len(membersMap)==1:
                            sender = list(membersMap.values())[0]
                ...
                if row[4] == 1:
                    ...
                    if info is not None:
                        ...
                        row_list.append('')
            #if sender == '' and  '2025' in row[8]:
            #    print("check")
            #if '邓恒恒：三花曲线图片问题排查' in row[7]:
            #    print('check')
            del row_list[0]
            del row_list[0]
            del row_list[0]
