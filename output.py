...
# from util.exporter.exporter_ai_txt import AiTxtExporter
# from util.exporter.exporter_csv import CSVExporter
# from util.exporter.exporter_docx import DocxExporter
# from util.exporter.exporter_html import HtmlExporter
# from util.exporter.exporter_json import JsonExporter
# from util.exporter.exporter_txt import TxtExporter
from DataBase.hard_link import decodeExtraBuf
from DataBase.package_msg import PackageMsg
from DataBase import media_msg_db, hard_link_db, micro_msg_db, msg_db
from log import logger
from person import Me
from util.image import get_image

# OUTPUT_DIR = 'C:/Users/bester/Desktop'
...
class Output():
    ...
    def to_csv_all(self):
        ...
        columns = ['StrContent','StrTime', 'Remark', 'NickName', 'Sender']
